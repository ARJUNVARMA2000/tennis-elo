...
const STEPS = [
  ...
  ["Monte Carlo draws", "Pairwise probabilities drive thousands of simulated single-elimination draws for per-round and title odds. Live tournaments use the real remaining bracket: validated first-party ATP/WTA draws are preferred, Wikipedia supplies a complete-draw fallback, and ESPN results advance the field. If no complete ordered draw is available yet, ESPN's posted matchups pin the known frontier and the still-unknown pairings remain explicitly projected — never presented as an official bracket."],
