...
| wta | 1823 | 1091 | 32 | 655 | 45 | 0 | 7 | 15 | 35 | 2026-05-02..2026-09-13 |

## Headline (scored set)

| slice | n | model LL | kalshi LL | d_ll ±SE | d_brier ±SE | acc model | acc kalshi |
|---|---|---|---|---|---|---|---|
| pooled | 1264 | 0.5967 | 0.5912 | -0.0054 ±0.0054 | -0.0030 ±0.0022 | 0.669 | 0.676 |
| atp | 621 | 0.6185 | 0.6174 | -0.0012 ±0.0073 | -0.0014 ±0.0029 | 0.649 | 0.666 |
| wta | 643 | 0.5755 | 0.5660 | -0.0095 ±0.0078 | -0.0044 ±0.0032 | 0.687 | 0.685 |
| pooled/live_aligned | 347 | 0.5727 | 0.5530 | -0.0198 ±0.0083 | -0.0082 ±0.0034 | 0.695 | 0.696 |
...
|---|---|---|---|---|---|---|---|
| pred_source: live aligned | 347 | -0.0198 ±0.0083 | -0.0082 ±0.0034 | -2.4 | 0.695 | 0.696 | |
| pred_source: backtest | 917 | +0.0000 ±0.0067 | -0.0010 ±0.0027 | +0.0 | 0.659 | 0.668 | |
| top-20 involved | 465 | +0.0070 ±0.0075 | +0.0011 ±0.0025 | +0.9 | 0.734 | 0.732 | |
| no top-20 player | 799 | -0.0127 ±0.0073 | -0.0053 ±0.0031 | -1.7 | 0.630 | 0.643 | |
| both inside top-50 | 311 | +0.0010 ±0.0089 | -0.0003 ±0.0039 | +0.1 | 0.664 | 0.654 | |
| someone outside top-50 | 953 | -0.0075 ±0.0065 | -0.0038 ±0.0026 | -1.2 | 0.670 | 0.683 | |
| best rank 1-10 | 281 | +0.0219 ±0.0102 | +0.0056 ±0.0031 | +2.1 | 0.744 | 0.737 | |
...
| kalshi favorite 0.5-0.6 | 358 | -0.0241 ±0.0093 | -0.0113 ±0.0043 | -2.6 | 0.499 | 0.536 | |
...
| surface: Hard | 414 | -0.0118 ±0.0084 | -0.0046 ±0.0035 | -1.4 | 0.684 | 0.678 | |
...
| tier: grand_slam | 503 | -0.0106 ±0.0092 | -0.0057 ±0.0035 | -1.2 | 0.733 | 0.746 | |
...
| round late (QF-F) | 149 | +0.0009 ±0.0116 | -0.0006 ±0.0051 | +0.1 | 0.644 | 0.631 | |
...
| month 2026-09 | 126 | -0.0165 ±0.0109 | -0.0081 ±0.0043 | -1.5 | 0.802 | 0.794 | |
| agree (<0.05) | 684 | +0.0001 ±0.0027 | -0.0006 ±0.0009 | +0.0 | 0.711 | 0.705 | |
| mild disagree (0.05-0.10) | 380 | -0.0124 ±0.0094 | -0.0057 ±0.0035 | -1.3 | 0.620 | 0.653 | |
| big disagree (>=0.1) | 200 | -0.0109 ±0.0273 | -0.0056 ±0.0117 | -0.4 | 0.618 | 0.618 | |
| tour: atp | 621 | -0.0012 ±0.0073 | -0.0014 ±0.0029 | -0.2 | 0.649 | 0.666 | |
| tour: wta | 643 | -0.0095 ±0.0078 | -0.0044 ±0.0032 | -1.2 | 0.687 | 0.685 | |
...
- T-5 vs T-30 price divergence: n=1264, mean |Δ|=0.0017, p95=0.0086, >0.05 in 2 rows (systemic divergence ⇒ early starts leaking in-play info ⇒ flip LEAD_MIN to 30).
- T-5 vs T-30 by month (a month-local p95 spike = in-play prints the pooled stats hide): 2026-05 p95=0.0091 (n=499, >0.05: 1) | 2026-06 p95=0.0087 (n=338, >0.05: 0) | 2026-07 p95=0.0088 (n=27, >0.05: 0) | 2026-08 p95=0.0086 (n=274, >0.05: 1) | 2026-09 p95=0.0039 (n=126, >0.05: 0)
- Scored quotes stamped after their 08:00 anchor: 0 (must be 0 — requoter + health gate enforce; >0 means the pending-race freeze escaped again).
- Our winner vs Kalshi settlement disagreements: 0 (join bugs surface here; these rows are auto-healed, so a persistent nonzero means healing failed).
- Sensitivity incl. retirements: n=1264, d_ll -0.0054 ±0.0054 — vacuous by construction: matched retired rows never carry p_model (the backtest OOS frame is completed-only), so this can equal the headline; it detects nothing until a live-forecast retirement lands.
