...
| wta | 1927 | 1148 | 49 | 679 | 51 | 0 | 8 | 15 | 44 | 2026-05-02..2026-09-21 |

## Headline (scored set)

| slice | n | model LL | kalshi LL | d_ll ±SE | d_brier ±SE | acc model | acc kalshi |
|---|---|---|---|---|---|---|---|
| pooled | 1322 | 0.5978 | 0.5914 | -0.0064 ±0.0053 | -0.0035 ±0.0021 | 0.668 | 0.677 |
| atp | 628 | 0.6198 | 0.6196 | -0.0002 ±0.0073 | -0.0012 ±0.0029 | 0.650 | 0.665 |
| wta | 694 | 0.5779 | 0.5658 | -0.0121 ±0.0075 | -0.0055 ±0.0031 | 0.684 | 0.689 |
| pooled/live_aligned | 399 | 0.5773 | 0.5543 | -0.0229 ±0.0081 | -0.0097 ±0.0034 | 0.689 | 0.702 |
...
|---|---|---|---|---|---|---|---|
| pred_source: live aligned | 399 | -0.0229 ±0.0081 | -0.0097 ±0.0034 | -2.8 | 0.689 | 0.702 | |
...
| no top-20 player | 849 | -0.0142 ±0.0070 | -0.0060 ±0.0030 | -2.0 | 0.631 | 0.647 | |
| both inside top-50 | 319 | -0.0019 ±0.0088 | -0.0016 ±0.0038 | -0.2 | 0.660 | 0.654 | |
| someone outside top-50 | 1003 | -0.0078 ±0.0063 | -0.0041 ±0.0025 | -1.2 | 0.670 | 0.685 | |
...
| best rank 51-100 | 319 | -0.0074 ±0.0124 | -0.0035 ±0.0053 | -0.6 | 0.603 | 0.599 | |
...
| kalshi favorite 0.6-0.7 | 365 | -0.0048 ±0.0093 | -0.0018 ±0.0043 | -0.5 | 0.627 | 0.625 | |
| kalshi favorite 0.7-0.8 | 310 | -0.0024 ±0.0090 | -0.0008 ±0.0036 | -0.3 | 0.744 | 0.742 | |
| kalshi favorite 0.8-0.9 | 185 | +0.0163 ±0.0167 | +0.0051 ±0.0059 | +1.0 | 0.838 | 0.832 | |
| kalshi favorite 0.9-1.0 | 86 | +0.0127 ±0.0299 | +0.0011 ±0.0076 | +0.4 | 0.942 | 0.930 | |
| surface: Hard | 472 | -0.0138 ±0.0081 | -0.0058 ±0.0033 | -1.7 | 0.680 | 0.682 | |
...
| tier: atp250 | 359 | -0.0078 ±0.0115 | -0.0042 ±0.0048 | -0.7 | 0.599 | 0.613 | |
| tier: atp500 | 228 | -0.0115 ±0.0097 | -0.0056 ±0.0044 | -1.2 | 0.618 | 0.629 | |
...
| round late (QF-F) | 163 | -0.0036 ±0.0108 | -0.0026 ±0.0048 | -0.3 | 0.638 | 0.632 | |
...
| month 2026-09 | 182 | -0.0213 ±0.0113 | -0.0107 ±0.0046 | -1.9 | 0.758 | 0.777 | |
| agree (<0.05) | 718 | -0.0005 ±0.0027 | -0.0009 ±0.0009 | -0.2 | 0.709 | 0.705 | |
...
| tour: wta | 694 | -0.0121 ±0.0075 | -0.0055 ±0.0031 | -1.6 | 0.684 | 0.689 | |
...
| 0.2-0.3 | 119 | 0.253 | 0.261 |
| 0.3-0.4 | 167 | 0.354 | 0.347 |
| 0.4-0.5 | 230 | 0.451 | 0.470 |
| 0.5-0.6 | 209 | 0.552 | 0.541 |
...
- T-5 vs T-30 price divergence: n=1322, mean |Δ|=0.0017, p95=0.0086, >0.05 in 2 rows (systemic divergence ⇒ early starts leaking in-play info ⇒ flip LEAD_MIN to 30).
- T-5 vs T-30 by month (a month-local p95 spike = in-play prints the pooled stats hide): 2026-05 p95=0.0091 (n=499, >0.05: 1) | 2026-06 p95=0.0087 (n=338, >0.05: 0) | 2026-07 p95=0.0088 (n=27, >0.05: 0) | 2026-08 p95=0.0086 (n=276, >0.05: 1) | 2026-09 p95=0.0071 (n=182, >0.05: 0)
- Scored quotes stamped after their 08:00 anchor: 0 (must be 0 — requoter + health gate enforce; >0 means the pending-race freeze escaped again).
- Our winner vs Kalshi settlement disagreements: 0 (join bugs surface here; these rows are auto-healed, so a persistent nonzero means healing failed).
- Sensitivity incl. retirements: n=1322, d_ll -0.0064 ±0.0053 — vacuous by construction: matched retired rows never carry p_model (the backtest OOS frame is completed-only), so this can equal the headline; it detects nothing until a live-forecast retirement lands.
