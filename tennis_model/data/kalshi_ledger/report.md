...
|---|---|---|---|---|---|---|---|
| pooled | 1021 | 0.6129 | 0.6125 | -0.0005 ±0.0062 | -0.0011 ±0.0025 | 0.646 | 0.653 |
...
| pooled/live_aligned | 106 | 0.6752 | 0.6691 | -0.0061 ±0.0136 | -0.0028 ±0.0060 | 0.538 | 0.524 |
...
|---|---|---|---|---|---|---|---|
| pred_source: live aligned | 106 | -0.0061 ±0.0136 | -0.0028 ±0.0060 | -0.4 | 0.538 | 0.524 | |
...
| no top-20 player | 670 | -0.0052 ±0.0080 | -0.0024 ±0.0035 | -0.7 | 0.619 | 0.629 | |
...
| best rank 21-50 | 363 | -0.0129 ±0.0089 | -0.0057 ±0.0040 | -1.5 | 0.628 | 0.664 | |
...
| surface: Hard | 171 | +0.0088 ±0.0139 | +0.0040 ±0.0059 | +0.6 | 0.573 | 0.547 | |
...
| round late (QF-F) | 136 | +0.0017 ±0.0122 | -0.0001 ±0.0054 | +0.1 | 0.632 | 0.618 | |
...
| month 2026-08 | 157 | +0.0082 ±0.0123 | +0.0028 ±0.0054 | +0.7 | 0.561 | 0.538 | |
| agree (<0.05) | 537 | +0.0002 ±0.0032 | -0.0006 ±0.0011 | +0.1 | 0.682 | 0.678 | |
| mild disagree (0.05-0.10) | 317 | -0.0021 ±0.0101 | -0.0026 ±0.0039 | -0.2 | 0.614 | 0.647 | |
...
- T-5 vs T-30 price divergence: n=1021, mean |Δ|=0.0020, p95=0.0099, >0.05 in 2 rows (systemic divergence ⇒ early starts leaking in-play info ⇒ flip LEAD_MIN to 30).
- T-5 vs T-30 by month (a month-local p95 spike = in-play prints the pooled stats hide): 2026-05 p95=0.0091 (n=499, >0.05: 1) | 2026-06 p95=0.0087 (n=338, >0.05: 0) | 2026-07 p95=0.0088 (n=27, >0.05: 0) | 2026-08 p95=0.0123 (n=157, >0.05: 1)
- Scored quotes stamped after their 08:00 anchor: 0 (must be 0 — requoter + health gate enforce; >0 means the pending-race freeze escaped again).
- Our winner vs Kalshi settlement disagreements: 0 (join bugs surface here; these rows are auto-healed, so a persistent nonzero means healing failed).
- Sensitivity incl. retirements: n=1021, d_ll -0.0005 ±0.0062 — vacuous by construction: matched retired rows never carry p_model (the backtest OOS frame is completed-only), so this can equal the headline; it detects nothing until a live-forecast retirement lands.
